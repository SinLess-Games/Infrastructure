...
* Treat each linked file as an **ADR** (Architectural Decision Record).
...
| [ADR-0004](./ADRs/ADR-0004.md) | Proxmox dashboard HA via Keepalived VIP + HAProxy round-robin                       | ACCEPTED | SinLess Games LLC | 2025-12-27    |
| [ADR-0005](./ADRs/ADR-0005.md) | Ceph storage model (Proxmox-integrated) + OSD groups                                | ACCEPTED | SinLess Games LLC | 2025-12-27    |
| [ADR-0006](./ADRs/ADR-0006.md) | Kubernetes distribution choice: RKE2 (K3s-family)                                   | ACCEPTED | SinLess Games LLC | 2025-12-27    |
...
| [ADR-0009](./ADRs/ADR-0009.md) | Identity & SSO: Authentik as central OIDC provider                                  | ACCEPTED | SinLess Games LLC | 2025-12-27    |
| [ADR-0010](./ADRs/ADR-0010.md) | Certificate management: cert-manager + Cloudflare DNS-01 (material stored in Vault) | ACCEPTED | SinLess Games LLC | 2025-12-27    |
| [ADR-0011](./ADRs/ADR-0011.md) | External access: Cloudflare Tunnel + Access (no inbound management)                 | ACCEPTED | SinLess Games LLC | 2025-12-27    |
| [ADR-0012](./ADRs/ADR-0012.md) | Secrets management & PKI: HashiCorp Vault                                           | ACCEPTED | SinLess Games LLC | 2025-12-27    |
| [ADR-0013](./ADRs/ADR-0013.md) | Backups & DR: Proxmox Backup Server + Velero (MinIO S3 backend)                     | ACCEPTED | SinLess Games LLC | 2025-12-27    |
...
## Planned ADRs (not yet assigned)

These are known upcoming decision areas that should be captured as ADRs once the implementation approach is finalized.

* Local DNS: Technitium DNS Server and split-horizon strategy (with Cloudflare)
* Multi-domain strategy (naming conventions, delegation, wildcard strategy, environment mapping)
* PXE/netboot build-out and node onboarding operating model
* RKE2 cluster topology specifics (VIPs, datastore/etcd placement, upgrade strategy)
* Proxmox Ceph pool taxonomy and placement rules (fast/capacity, service tiering)
* GitLab runner fleet operating model (placement, isolation, scaling, credentials)
