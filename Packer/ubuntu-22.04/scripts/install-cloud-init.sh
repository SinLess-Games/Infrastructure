...
#
# Install and configure cloud-init for ubuntu-22.04-template-pve-01.
# Rendered by Ansible into:
#   Packer/ubuntu-22.04/scripts/install-cloud-init.sh
...
VM_NAME="ubuntu-22.04-template-pve-01"
DISTRO="ubuntu-22.04"
