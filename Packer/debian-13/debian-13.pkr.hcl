# Generated Packer HCL for debian-13
...
variable "vm_name" {
  type    = string
  default = "debian-13-template-pve-05"
}
...
variable "template_description" {
  type    = string
  default = "Debian 13 template built by Packer for pve-05"
}
...
source "proxmox-iso" "vm_template" {
  ...
  boot_command = [
    ...
    "hostname=debian-13-template-pve-05 ",
