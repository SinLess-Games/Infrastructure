...
#
# Prepare debian-13 template build for pve-05.
# This script is rendered by Ansible and written into:
#   Packer/debian-13/prepare-build.sh
...
DISTRO="debian-13"
VM_NAME="debian-13-template-pve-05"
PROXMOX_NODE="pve-05"
ISO_URL="https://cdimage.debian.org/debian-cd/current/amd64/iso-cd/debian-13.4.0-amd64-netinst.iso"
ISO_FILENAME="debian-13.4.0-amd64-netinst.iso"
ISO_HOST="cdimage.debian.org"
