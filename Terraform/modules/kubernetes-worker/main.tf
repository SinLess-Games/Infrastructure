# =====================================================================
# Kubernetes Worker Terraform Module - Main Resources
# =====================================================================
...
resource "proxmox_vm_qemu" "worker" {
  ...
  description = <<-EOT
    ...
    **Kubernetes Role:**
    - Role: Worker Node (kubelet, container runtime, kube-proxy)
    - RKE2 Version: Latest from channel
    - Storage: Local + Ceph integration ready
    - Workload Types: General compute, storage, networking pods
  EOT
